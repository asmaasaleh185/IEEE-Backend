...
@section('content')
    <div class="container mx-auto p-6">
        <div class="flex justify-between">
            ...
            <a href="{{ route('authors.create') }}" class="bg-blue-500 text-white p-2 rounded">Add New Author</a>
        </div>
        <div class="mt-6">
            <ul class="space-y-4">
                    ...
                    <li class="p-4 bg-white/5 rounded-xl border border-transparent hover:border-blue-500 group transation-colors duration-300">
                        ...
                        <div class="mt-4">
                            <a href="{{ route('authors.show', $author->id) }}"
                                class="bg-white/10 px-2 py-1 text-sm hover:bg-white/25 rounded-xl font-bold transition-colors duration-300">View</a>
                            <a href="{{ route('authors.edit', $author->id) }}"
                                class="text-blue-500 bg-white/10 px-2 py-1 text-sm hover:bg-white/25 rounded-xl font-bold transition-colors duration-300 ml-3">Edit</a>
